...
curl -X POST "https://your-app.com/api/habits" \
  ...
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"name": "Test Habit", "category": "health"}'
```
...
await page.context().add_cookies([{
    ...
    "domain": "habit-tracker-app-60.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://habit-tracker-app-60.preview.emergentagent.com");
```
